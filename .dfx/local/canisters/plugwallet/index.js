...
import { idlFactory } from './plugwallet.did.js';
export { idlFactory } from './plugwallet.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PLUGWALLET;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./plugwallet.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the plugwallet canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./plugwallet.did.js")._SERVICE>}
 */
export const plugwallet = createActor(canisterId);
