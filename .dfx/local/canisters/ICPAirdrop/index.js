...
import { idlFactory } from './ICPAirdrop.did.js';
export { idlFactory } from './ICPAirdrop.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ICPAIRDROP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ICPAirdrop.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ICPAirdrop canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ICPAirdrop.did.js")._SERVICE>}
 */
export const ICPAirdrop = createActor(canisterId);
